...
<head>
	...
	<script type="text/javascript">
        //给删除a标签绑定单击事件，实现confirm功能，单击链接之后先执行该事件，再确定发送请求还是取消请求
        $(function () {
...
<div id="main">
	<table>
		...
		<tr>
			...
			<td></td>
			<td>
				<a href="pages/manager/book_edit.jsp?method=add&pageNo=
				${ requestScope.page.pageTotalCount%requestScope.page.pageTotal != 0 ? requestScope.page.pageTotal: (requestScope.page.pageTotal+1)}">
				   添加图书
				</a>
			</td>
		</tr>
